...
public class ConfigUtils {
    ...
    private ConfigUtils() {
        ...
        switch (env) {
            case "TESTING" ->
                    properties = PropertiesUtils.loadProperties("src/test/resources/properties/testing.properties");
            case "STAGING" ->
                    properties = PropertiesUtils.loadProperties("src/test/resources/properties/staging.properties");
            case "PRODUCTION" ->
                    properties = PropertiesUtils.loadProperties("src/test/resources/properties/production.properties");
